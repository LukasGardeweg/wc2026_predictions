...
RAW_FILE = os.path.join(BASE, "Einzelspielprognosen", "raw_single_odds_during_wm.xlsx")
OUT_FILE = os.path.join(BASE, "Einzelspielprognosen", "processed_match_predictions.xlsx")
